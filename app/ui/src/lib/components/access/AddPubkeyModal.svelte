...
>
	...
	<div class="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 shadow-xl">
		...
		<div class="p-6 space-y-4">
			<!-- Pubkey input -->
			<div>
				<label for="pubkey-input" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
			...
			<div>
				<label for="extra-input" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
			...
			{#if validationResult}
				<div class="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
					<div class="flex items-start space-x-2">
						...
						<div class="min-w-0">
							<p class="text-sm font-medium text-green-700 dark:text-green-300">Validated</p>
							<p class="text-xs text-green-600 dark:text-green-400 font-mono truncate">{validationResult.npub}</p>
							{#if validationResult.source === 'nip05'}
								<p class="text-xs text-green-600 dark:text-green-400 mt-1">Resolved from NIP-05</p>
							{/if}
						</div>
					</div>
				</div>
